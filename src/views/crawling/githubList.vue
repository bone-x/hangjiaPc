<template>
  <div class="crawling-github-container">
    <div>
      <el-form
        :model="formData"
        ref="form"
      ...
      >
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item size="large">
              <el-button
                v-permission="['github:data:export']"
                type="primary"
    ...
    <div class="tableData">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <router-link :to="{ name: 'ReadMe', params: { id: scope.row.id } }">
              <el-button
                type="primary"
                size="mini"
                plain
                v-permission="['github:data:readme']"
              >查看readme</el-button>
            </router-link>
            <span v-permission="['github:data:ignore']">
              <el-button
    ...
    <el-row style="margin-top: 20px;">
      ...
      >
        <el-button
          v-permission="['github:data:ignore']"
          type="danger"
  ...
  methods: {
    ...
    getGithubList() {
      getListBySet(this.queryData)
        .then(res => {
          this.githubList = res.result.list;
