        ...
        >
          <el-row>
            ...
            <el-col :span="8">
              ...
              >
                <el-select
                  v-model="selectOrgGoodsForm.orgName"
                  placeholder="请选择"
                  style="width:220px"
                >
                  <el-option
...
export default {
  ...
  methods: {
    ...
    async getDetails() {
      ...
      const res = await getGoodsDetails(this.goodsId);
      if (res.code !== 200) return false;
      nameList = res.result.hjGoodsNames.split(',');
      this.ruleForm.bindingGoods = nameList.join(', ');
      this.ruleForm.hjGoodsId = res.result.hjGoodId;
    ...
    // 生成链接
    handleCreateUrl() {
      // if (!this.ruleForm.operatorList.length) return false;
      getLinks({
