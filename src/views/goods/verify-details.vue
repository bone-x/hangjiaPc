 ...
 * @LastEditTime: 2019-08-27 09:45:26
      ...
      >
        ...
        <el-form-item label="是否商品推荐：" prop="isRecomment">
          <el-radio-group v-model="ruleForm.isRecommend">
            <el-radio :label= false :disabled="state.disabledGoodsIsRecomment" style="width: 70px;">否</el-radio>
            <el-radio :label= true :disabled="state.disabledGoodsIsRecomment" style="width: 70px;">是</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item style="margin-top: 50px;">
          <el-button type="primary" @click.native="submitForm('ruleForm')">通过</el-button>
          <el-button style="margin-left: 100px;" @click.native="goBack">拒绝</el-button>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    async initData() {
      ...
      getGoodsDetailsById(this.id).then(res => {
        ...
        console.log(this.ruleForm.isRecommend);
