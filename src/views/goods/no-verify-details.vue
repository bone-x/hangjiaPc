 ...
 * @LastEditTime: 2019-08-27 09:41:05
...
<template>
  <div class="content-container">
    ...
    <section class="goods-list-edit">
      ...
      >
        ...
        >
          <el-col :span="8">
            ...
            <!-- <el-input
              :value="ruleForm.courseName"
              disabled
              style="width: 100%;"
              size="medium"
            ></el-input> -->
            <span class="courseName">{{ ruleForm.courseName }}</span>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="商品动态封面：">
          ...
          >
            <div style="position: relative; width: 288px; height: 180px; margin-left: 0;">
              <figure-keyframes
                :cover="ruleForm.featureImgs[0]"
                :keyframes="ruleForm.featureImgs"
              ></figure-keyframes>
            </div>
            <multi-upload-image
              :files="ruleForm.featureImgs"
              @successCBK="onMultiUploadSuccess"
            >
              <el-button
                icon="el-icon-upload"
                size="medium"
        ...
        >
          ...
          >
            <el-radio
              disabled
              v-model="ruleForm.goodsPriceType"
              :label="0"
              style="width: 70px;"
            >免费</el-radio>
            <el-radio
            ...
            >
              <el-row
                v-show="ruleForm.goodsPriceType == 1"
                type="flex"
                align="middle"
              >
                <el-col :span="7">
        ...
        >
          ...
          >
            ...
            >
              <el-row
                v-show="ruleForm.goodsStockType === 1"
                type="flex"
                align="middle"
              >
                <el-col :span="7">
        ...
        >
          ...
          >
            ...
            >
              <el-row
                v-show="ruleForm.goodsValidityType == 1"
                type="flex"
                align="middle"
              >
                <el-col :span="7">
        ...
        >
          <el-col :span="20">
            <div style="position: relative;">
              ...
              />
              <div
                v-if="state.disabledGoodsIntroduction=false"
                class="disabled-mask"
              ></div>
            </div>
          </el-col>
        ...
        <el-form-item style="margin-top: 50px;">
          ...
          <el-button
            ...
            plain
            @click="state.dialogFormVisible = true"
          >拒绝</el-button>
        </el-form-item>
      </el-form>
        ...
        >
            ...
            <el-col :span="6">
              <el-row>
                ...
                <el-col
                  ...
                  center
                >
                  <el-button @click.native="selectCourseForm.courseNo = '', selectCourseForm.courseName = ''">清空</el-button>
                </el-col>
              </el-row>
            </el-col>
          </el-row>
          ...
          >
            ...
            >
              <el-button
                type="primary"
                @click.native="onCourseWindowConfirm"
              >确定</el-button>
            </el-col>
          </el-row>
        </el-form>
        ...
        >
          ...
          >
            ...
            >
              <el-button
                type="primary"
                @click.native="onLecturerWindowConfirm"
              >确定</el-button>
            </el-col>
          </el-row>
        </el-form>
      ...
      <el-dialog
        title="拒绝原因"
        :visible.sync="state.dialogFormVisible"
      >
        ...
        <div
          ...
          class="dialog-footer"
        >
          <el-button @click="state.dialogFormVisible = false, rejectForm.reason = ''">取 消</el-button>
          <el-button
            type="primary"
  ...
  methods: {
    ...
    async initData() {
      ...
      getGoodsDetailsById(this.id).then(res => {
        ...
        this.ruleForm.goodsCover = decodeURIComponent(res.result.coverPicture);
        this.ruleForm.featureType = res.result.dynamicCoverType;
        this.ruleForm.featureImgs = res.result.dynamicCover
          .split(',')
        ...
        this.ruleForm.isRecommend = res.result.isRecommend;
    ...
    submitForm() {
      const options = {
        ...
        coverPicture: encodeURIComponent(this.ruleForm.goodsCover),
        basicBuyCount: this.ruleForm.goodsBaseNum,
        introduction: this.ruleForm.goodsIntroduction,
        isRecommend: this.ruleForm.isRecommend,
      };
      const res = checkOrgGoods(options);
