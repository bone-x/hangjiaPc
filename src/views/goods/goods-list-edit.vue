 ...
 * @LastEditTime: 2019-08-27 10:08:37
      ...
      >
        ...
        <el-form-item label="商品名称：" prop="goodsName">
          <el-col :span="8">
            <el-input
              ...
              :disabled="state.disabledGoodsName"
              style="width: 100%;"
              size="medium"
              placeholder="请输入商品名称"
            ></el-input>
        ...
        <el-form-item label="商品类目：" prop="goodsCategory">
          <el-col :span="8">
            <el-cascader
              ...
              :disabled="state.disabledGoodsCategory"
              style="display: block;"
              size="medium"
              separator=" -> "
        ...
        <el-form-item label="商品动态封面：">
            ...
            <el-col :span="12">
              <el-radio-group v-model="ruleForm.featureType">
                <el-radio
                  ...
                  style="width: 70px;"
                >不设置</el-radio>
                <el-radio :disabled="state.disableGoodsPriceType" :label="1" style="width: 70px;">图片</el-radio>
                <el-radio :disabled="state.disableGoodsPriceType" :label="2" style="width: 70px;">视频</el-radio>
              </el-radio-group>
            </el-col>
          </el-row>
          ...
          >
            ...
            <multi-upload-image v-if="state.disableGoodsKeyFrames" :files="ruleForm.featureImgs" @successCBK="onMultiUploadSuccess">
              <el-button icon="el-icon-upload" size="medium" style="margin-left: 40px;">上传商品动态图片</el-button>
            </multi-upload-image>
            <el-button
              v-else
        ...
        <el-form-item class="cell-height-40" label="商品价格：" prop="goodsPriceType">
          <el-row type="flex" align="middle">
            <el-radio
              ...
              :disabled="state.disabledGoodsPrice"
              :label="0"
              style="width: 70px;"
            >免费</el-radio>
            <el-radio
        ...
        <el-form-item class="cell-height-40" label="商品库存：" prop="goodsStockType">
          <el-row type="flex" align="middle">
            <el-radio
              ...
              :disabled="state.disabledGoodsStock"
              :label="0"
              style="width: 70px;"
            >不限</el-radio>
            <el-radio
        ...
        <el-form-item class="cell-height-40" label="商品有效期：" prop="goodsValidityType">
          <el-row type="flex" align="middle">
            <el-radio
              ...
              :disabled="state.disabledGoodsValidity"
              :label="0"
              style="width: 70px;"
            >不限</el-radio>
            <el-radio
          ...
          <el-row type="flex" align="middle">
            <el-col :span="6">
              <el-input
                ...
                :disabled="state.disabledGoodsBaseNum"
                clearable
                min="1"
                max="24"
                size="medium"
        ...
        <el-form-item label="是否商品推荐：" prop="isRecomment">
          <el-radio-group v-model="ruleForm.isRecomment">
            <el-radio :label="0" :disabled="state.disabledGoodsIsRecomment" style="width: 70px;">否</el-radio>
            <el-radio :label="1" :disabled="state.disabledGoodsIsRecomment" style="width: 70px;">是</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        <el-form-item label="商品简介：" prop="goodsIntroduction">
          <el-col :span="20">
            <div style="position: relative;">
              ...
              />
              <div v-if="state.disabledGoodsIntroduction" class="disabled-mask"></div>
            </div>
          </el-col>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async initData() {
      ...
      getGoodsDetailsById(this.id).then(res => {
        ...
        this.getCourseListById(res.result.courseId).then(courseList => {
          const firstItem = courseList;
          if (!firstItem) return;
          this.selectCourseForm.selectedItem = firstItem;
          this.selectCourseForm.selectedVal = firstItem.id;
    ...
    // 获取课程列表
    async getCourseListById(courseId) {
      const options = {
        courseId,
        page: 1,
        limit: 10
      ...
      return Promise.resolve(res.result.list[0]);
    },
