  ...
  <div class="content-container">
    ...
    <el-row :gutter="20">
      ...
      <el-form-item label="备注">
        <el-input type="textarea" v-model="ruleForm.desc" placeholder="输入听课卡备注信息" maxlength="100"></el-input>
      </el-form-item>
      <el-form-item>
...
<script>
import {AddDataDetails} from "@/api/operation";
        ...
        console.log(valid)
         if (valid) {
            const option = {
              ...
              cardRemark: this.ruleForm.desc || "",
              status:1,
            }
        AddDataDetails(option).then(res => {
          console.log(res)
          this.$message({
            type:'success',
            message:'新建成功'
