  ...
  <div class="content-container">
    ...
    <div class="addnew">
      ...
      <div class="killprice">
        ...
        <span class="tip2">抢购价不得高于商品原价</span>
      </div>
      <div class="killprice">
...
export default {
  ...
  methods: {
    ...
    getSingleData() {
      ...
      console.log("路由跳转带的id", this.goodsActivityId);
      // 存放时间
      const timeList = [];
      if (this.goodsActivityId) {
        fastestSingleCheck(this.goodsActivityId).then(res => {
          ...
          // 赋值商品名称
          this.goodsMsg.goodsid = this.singleData.goods.id;
          this.goodsMsg.goodsname = this.singleData.goods.name;
          // 赋值教师名称
          this.goodsMsg.teacher = this.singleData.goods.teacherNames;
          // 赋值商品原价
          this.goodsMsg.price = this.singleData.goods.price;
          // 赋值可用库存
